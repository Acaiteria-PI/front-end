...
<template>
  <table class="border border-neutral-300 rounded-xl border-separate border-spacing-0 table-auto">
    <thead>
      <tr>
        <th
    ...
    <tbody>
      <tr v-for="product in products" :key="product.id" class="border-t border-neutral-300">
        ...
        <td class="p-2 border-t border-neutral-300">{{ product.expiryDate }}</td>
