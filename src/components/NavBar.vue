    ...
    >
        ...
        <ul class="flex gap-12 items-center">
          <li>
            ...
            >
              Início
              <span
                class="absolute bottom-0 left-0 w-0 h-0.5 bg-rose-900 transition-all group-hover:w-full"
              ></span>
            </router-link>
          </li>
          <li>
      ...
      <div class="flex items-center gap-6">
        ...
        <div v-if="authStore.isLoggedIn">
          <ProfileDropdown @open-logout="openLogout" />
          <ConfirmLogout :show="showLogoutConfirm" @close="closeLogout" />
        </div>
